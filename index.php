            ...
            <div class="feed-posts">
                <?php if (empty($posts)) { ?>
                    <div class="feed-empty">
                        ...
                        <p>Siga pessoas para ver seus posts aqui!</p>
                    </div>
                <?php } else { ?>
    ...
    <script>
        ...
        document.querySelectorAll('.comentario-enviar').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                comentarioTimeout = setTimeout(() => {
                    comentarioTimeout = null;
                }, 1000);
        ...
        document.querySelectorAll('.comentario-input').forEach(input => {
            input.addEventListener('keypress', function(e) {
                if (e.key === 'Enter' && !comentarioTimeout) {
                    const postId = this.dataset.postId;
